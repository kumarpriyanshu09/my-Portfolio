...
export default function HealthcareSalesClient() {
  return (
    <ProjectPageLayout>
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <ul>
              <li><strong>Accessibility:</strong> Excel is widely used across organizations, making the dashboard
                immediately accessible to stakeholders without requiring specialized software.</li>
              <li><strong>Rapid Development:</strong> The built-in formulas and visualization capabilities allowed for
                quick implementation of a functional dashboard within tight timeframes.</li>
              <li><strong>Interactive Capabilities:</strong> Using data validation and conditional formatting, I created a
                responsive dashboard that updates dynamically as users filter the data.</li>
              <li><strong>Familiarity:</strong> Most business users are comfortable with Excel, reducing the learning
                curve and increasing adoption rates.</li>
            </ul>
          </div>
        </section>
        {/* The Challenge */}
        ...
        <section className="space-y-4">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <ul>
              <li><strong>Excel formulas:</strong> Advanced functions including SUMIFS and nested IF statements</li>
              <li><strong>Data validation:</strong> Creating interactive filtering capabilities</li>
              <li><strong>Conditional formatting:</strong> Visual indicators for performance metrics</li>
              <li><strong>Dashboard design:</strong> Effective layout and visualization principles</li>
              <li><strong>Data analysis:</strong> Converting raw data into actionable business insights</li>
            </ul>
          </div>
        </section>
